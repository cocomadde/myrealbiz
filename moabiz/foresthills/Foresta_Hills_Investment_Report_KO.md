...
본 분석에서는 대상 부동산 단품의 수익성에 더하여, 매수 주체인 **보유 법인(모아비즈 4기 현재 기준)의 결산서에 본 부동산을 신규 편입했을 때의 합산 착지(Landing) 결과**를 3열로 정밀 대조 검증하였습니다.

| 항목 (指標項目) | 검증대상 부동산 단품 | 모아비즈 4기현재 (Col G) | 검증대상 부동산 매입후결산서 착지 예상 |
| :--- | :---: | :---: | :---: |
| **1. 帳簿上税引前当期純利益 (장부상 세전순이익)** | **¥5,282,352** | ¥3,722,450 | **¥9,004,802** |
| **2. 税引前手残りCF (세전 잔여 현금흐름)** | **¥1,995,148** | ¥1,741,901 | **¥3,737,049** |
| 　・**税引前CF利回り (세전 CF 수익률)** | **1.62%** | 0.65% | **0.96%** |
| 　・**推定法人税額 (추정 법인세액)** | **¥1,320,588** | ¥930,613 | **¥2,251,201** |
| 　・**税引後手残りCF (세후 잔여 현금흐름)** | **¥674,560** | ¥811,289 | **¥1,485,848** |
| 　・**税引後CF利回り (세후 CF 수익률)** | **0.55%** | 0.30% | **0.38%** |
| **3. 債務償還年数 (채무상환년수, 년)** | **19.4년** | 24.1년 | **22.4년** |
| **4. 簡易 Cash Flow (=税引後CF)** | **¥674,560** | ¥811,289 | **¥1,485,848** |
| **5. ICR (이자보상배율, Interest Coverage Ratio)** | **2.3배** | 0.9배 | **1.2배** |
| **6. 負債返済割合 (DSCR / 부채상환배율)** | **1.6배** | 1.5배 | **1.5배** |
| **7. LTV (固定資産税評価額に基づく / 고정자산세 기준)**| **201.62%** | 261.08% | **239.23%** |
| **8. 投資額ROI (초기 투하자기자본 대비 ROI)** | **8.45%** | 3.83% | **5.40%** |
| **9. 法人貢献総合判定 (모아비즈 법인 편입 적격성 종합 판정)** | **우량 기여 (적합)** | 기준선 (ICR 0.9배 취약) | **적합 (우량 편입 대상 - 5대 핵심 지표 전방위 대폭 개선)** |

> **[법인 결산서 디자인 관점의 주요 분석]**
> 1. **장부상 당기순이익 대폭 개선**: 검증대상 부동산 단품에서 연간 528.2만 엔의 장부상 순이익이 창출되어, 매입 후 법인 전체의 세전순이익은 372.2만 엔에서 **900.5만 엔으로 약 2.4배 급증**합니다.
> 2. **금융기관 신용도 핵심 지표(채무상환년수) 단축**: 기존 법인의 채무상환년수가 24.1년에서 **22.4년으로 1.7년 단축**되어, 은행 평가상 차기 물건 매입을 위한 대출 적격성이 한층 강화됩니다.
> 3. **이자보상배율(ICR)의 1.0배 돌파**: 기존 0.9배로 은행 심사상 취약했던 ICR이 단품 2.3배의 우량 수익성 흡수에 힘입어 **1.2배로 건전화**되어 금융비용 감당 능력이 대폭 개선됩니다.
> 4. **고정자산세 기준 LTV 희석**: 단품의 LTV(201.6%)가 기존(261.1%)보다 낮아, 합산 LTV가 **239.2%로 21.85%p 개선**됩니다.
> 5. **법인 기여도 5대 핵심 지표 종합 판정 (ICR / DSCR / ROI / 장부순이익 / 캐시플로우)**:
>    - **ICR (이자보상배율)**: 기존 0.9배(취약) -> **1.2배로 +0.3배 대폭 개선** (은행 심사상 결격 기준인 1.0배를 돌파하여 건전화 달성).
>    - **DSCR (부채상환배율)**: **1.5배 완벽 유지** (금융기관 권고 안전 기준 1.20배를 대폭 상회).
>    - **ROI (자기자본수익률)**: 기존 3.83% -> **5.40%로 +1.57%p 대폭 상승** (투하 자기자본 대비 현금 창출력 대폭 제고).
>    - **장부상 당기순이익**: 연간 372.2만 엔 -> **900.5만 엔으로 +528.2만 엔(2.4배) 급증** (결산서상 건전한 흑자 대폭 확대).
>    - **실질 캐시플로우 (CF)**: 세후 실수령 현금흐름 81.1만 엔 -> **148.6만 엔으로 +67.5만 엔(1.83배) 대폭 확충** (안정적 잉여 현금 순유입).
>    - **종합 판정 결론**: **적합 (우량 편입 대상)** — 본 매물은 모아비즈 법인의 차입금 이자감당력(ICR), 자본수익성(ROI), 회계상 이익, 실질 유동성을 동시에 획기적으로 개선하며 부채상환 안전성(DSCR 1.5배)을 확고히 유지하므로 법인에 강력히 도움이 되는 최우량 물건으로 판정됨.
