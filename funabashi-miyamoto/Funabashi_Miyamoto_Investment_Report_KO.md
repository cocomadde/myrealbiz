...
| :--- | :---: | :--- | :---: | :---: | :---: | :--- |
| **도쿄(東京)역** (비즈니스/금융) | **약 34~37분** | 집 도보 9분 → JR 후나바시역 + JR 총부쾌속선 직통 25분 (도쿄역 지하 직결) | 도보 9분 | 25분 | **0회 (직통)** | 후나바시역은 총부쾌속 전 열차 정차역으로 배차 3~4분 간격, 압도적인 도쿄역 접근성 |
| **오테마치(大手町)역** (오피스/지하철결절) | **약 35~38분** | 집 도보 9분 → JR 후나바시역(3분) → 니시후나바시 환승 도쿄메트로 토자이선 통근쾌속(23분) | 도보 9분 | 26분 | 1회 | 토자이선 통근쾌속으로 오테마치역 중심 오피스 빌딩군 다이렉트 출근 |
| **신주쿠(新宿)역** (최대 터미널) | **약 48~52분** | 집 도보 9분 → JR 후나바시역 + JR 츄오·총부선 킨시초/오차노미즈 환승 츄오선 쾌속 | 도보 9분 | 37~40분 | 1회 | 킨시초 또는 오차노미즈에서 츄오선 쾌속으로 즉시 평면 환승 |
| **시부야(渋谷)역** (IT/트렌드) | **약 52~56분** | 집 도보 9분 → JR 후나바시역 총부쾌속 시나가와역(34분) → JR 야마노테선(12분) | 도보 9분 | 46분 | 1회 | 시나가와 또는 신바시 환승으로 시부야/롯폰기권 접근 원활 |
