...
| :--- | :---: | :--- | :---: | :---: | :---: | :--- |
| **신주쿠(新宿)역** (최대 터미널) | **약 78~82분** | 집 도보 1분 + 쿄쿠마에 버스 18분 → 본아츠기역 + 오다큐선 쾌속급행(快速急行) 직통 53분 | 도보/버스 20분 | 53분 | **0회 (전철 직통)** | 본아츠기역 시발 또는 오다큐 모닝웨이/쾌속급행 직통 운행. 도심 원거리 통근 한계선 |
| **시부야(渋谷)역** (IT/트렌드) | **약 78~82분** | 집 도보 1분 + 버스 18분 → 본아츠기역 + 오다큐선(44분) → 시모키타자와역 환승 게이오 이노카시라선 급행(5분) | 도보/버스 20분 | 49분 | 1회 | 시모키타자와역 대면 환승으로 시부야역 쾌속 진입 |
| **오테마치(大手町)역** (오피스/지하철결절) | **약 90~95분** | 집 도보 1분 + 버스 18분 → 본아츠기역 + 오다큐선 치요다선 직통(모닝웨이/급행) 68분 | 도보/버스 20분 | 68분 | 0~1회 | 치요다선 직결 열차 이용 시 환승 없이 오테마치역 도달 가능하나 통근 피로도 높음 |
| **도쿄(東京)역** (비즈니스/금융) | **약 92~96분** | 집 도보 1분 + 버스 18분 → 본아츠기역 + 오다큐 쾌속급행 신주쿠(53분) → JR 츄오선 쾌속(14분) | 도보/버스 20분 | 67분 | 1회 | 도쿄 도심 출퇴근보다는 아츠기·에비나·요코하마 및 내륙 산단 출퇴근에 최적화된 입지 |
